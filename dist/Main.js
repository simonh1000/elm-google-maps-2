...
var _elm_lang$virtual_dom$VirtualDom_Expando$viewTinyHelp = function (str) {
	return {
		...
		_1: _elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$virtual_dom$VirtualDom_Helpers$text(str)
			])
	};
};
var _elm_lang$virtual_dom$VirtualDom_Expando$purple = _elm_lang$virtual_dom$VirtualDom_Helpers$style(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'color', _1: 'rgb(136, 19, 145)'}
		]));
var _elm_lang$virtual_dom$VirtualDom_Expando$viewExtraTinyRecord = F3(
	function (length, starter, entries) {
		...
		if (_p0.ctor === '[]') {
			...
			var _p2 = _p0._0;
			var nextLength = (length + _elm_lang$core$String$length(_p2)) + 1;
			if (_elm_lang$core$Native_Utils.cmp(nextLength, 18) > 0) {
				...
				var _p1 = A3(_elm_lang$virtual_dom$VirtualDom_Expando$viewExtraTinyRecord, nextLength, ',', _p0._1);
				var finalLength = _p1._0;
				var otherNodes = _p1._1;
				return {
					ctor: '_Tuple2',
					_0: finalLength,
					_1: A2(
						_elm_lang$core$List_ops['::'],
						_elm_lang$virtual_dom$VirtualDom_Helpers$text(starter),
						A2(
							_elm_lang$core$List_ops['::'],
							A2(
								_elm_lang$virtual_dom$VirtualDom_Helpers$span,
								_elm_lang$core$Native_List.fromArray(
									[_elm_lang$virtual_dom$VirtualDom_Expando$purple]),
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$virtual_dom$VirtualDom_Helpers$text(_p2)
									])),
							otherNodes))
				};
			}
...
var _elm_lang$virtual_dom$VirtualDom_Expando$leftPad = function (maybeKey) {
	...
	if (_p3.ctor === 'Nothing') {
		...
		return _elm_lang$virtual_dom$VirtualDom_Helpers$style(
			_elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: 'padding-left', _1: '4ch'}
				]));
	}
};
var _elm_lang$virtual_dom$VirtualDom_Expando$makeArrow = function (arrow) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$virtual_dom$VirtualDom_Helpers$style(
				_elm_lang$core$Native_List.fromArray(
					[
						{ctor: '_Tuple2', _0: 'color', _1: '#777'},
						{ctor: '_Tuple2', _0: 'padding-left', _1: '2ch'},
						{ctor: '_Tuple2', _0: 'width', _1: '2ch'},
						{ctor: '_Tuple2', _0: 'display', _1: 'inline-block'}
					]))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$virtual_dom$VirtualDom_Helpers$text(arrow)
			]));
};
var _elm_lang$virtual_dom$VirtualDom_Expando$lineStarter = F3(
	function (maybeKey, maybeIsClosed, description) {
		var arrow = function () {
			var _p4 = maybeIsClosed;
			if (_p4.ctor === 'Nothing') {
		...
		var _p5 = maybeKey;
		if (_p5.ctor === 'Nothing') {
			return A2(_elm_lang$core$List_ops['::'], arrow, description);
		} else {
			return A2(
				_elm_lang$core$List_ops['::'],
				arrow,
				A2(
					...
					A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$virtual_dom$VirtualDom_Helpers$text(_p5._0)
							])),
					A2(
						_elm_lang$core$List_ops['::'],
						_elm_lang$virtual_dom$VirtualDom_Helpers$text(' = '),
	...
	function (n, func, list) {
		...
		if (_p6.ctor === '[]') {
			...
			return (_elm_lang$core$Native_Utils.cmp(n, 0) < 1) ? A2(
				...
				_elm_lang$core$List_ops['::'],
				_p7,
				A3(_elm_lang$virtual_dom$VirtualDom_Expando$updateIndex, n - 1, func, _p8));
		}
	});
			...
			return {
				...
				_1: _elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$virtual_dom$VirtualDom_Helpers$span,
						_elm_lang$core$Native_List.fromArray(
							[_elm_lang$virtual_dom$VirtualDom_Expando$red]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$virtual_dom$VirtualDom_Helpers$text(str)
							]))
			...
			return {
				...
				_1: _elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$virtual_dom$VirtualDom_Helpers$span,
						_elm_lang$core$Native_List.fromArray(
							[_elm_lang$virtual_dom$VirtualDom_Expando$blue]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$virtual_dom$VirtualDom_Helpers$text(_p11)
							]))
					])
			};
		case 'Sequence':
					...
					_1: A2(
						...
						A2(
							...
							A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$virtual_dom$VirtualDom_Helpers$text(_p16)
									])),
							A2(
								_elm_lang$core$List_ops['::'],
								_elm_lang$virtual_dom$VirtualDom_Helpers$text(' = '),
	...
	function (olds, news) {
		...
		if (_p30._0.ctor === '[]') {
			...
			if (_p30._1.ctor === '[]') {
				...
				return A2(
					_elm_lang$core$List_ops['::'],
					A2(_elm_lang$virtual_dom$VirtualDom_Expando$mergeHelp, _p30._0._0, _p30._1._0),
					A2(_elm_lang$virtual_dom$VirtualDom_Expando$mergeListHelp, _p30._0._1, _p30._1._1));
			}
		}
	});
				...
				switch (_p40.ctor) {
						...
						switch (_p41.ctor) {
							case 'None':
								return _elm_lang$core$Native_Utils.crashCase(
									'VirtualDom.Expando',
									{
										start: {line: 197, column: 11},
										end: {line: 207, column: 81}
									},
					...
					default:
						return _elm_lang$core$Native_Utils.crashCase(
							'VirtualDom.Expando',
							{
								start: {line: 192, column: 7},
								end: {line: 210, column: 50}
							},
				...
				switch (_p52.ctor) {
					...
					case 'Index':
						return _elm_lang$core$Native_Utils.crashCase(
							'VirtualDom.Expando',
							{
								start: {line: 213, column: 7},
								end: {line: 221, column: 77}
							},
		...
		switch (_p64.ctor) {
			case 'S':
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$virtual_dom$VirtualDom_Expando$leftPad(maybeKey)
						]),
					A3(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$virtual_dom$VirtualDom_Helpers$text(_p64._0)
									]))
							])));
			case 'Primitive':
				return A2(
					...
					return {
						...
						_1: isClosed ? A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[]),
							_elm_lang$core$Native_List.fromArray(
								[])) : _elm_lang$virtual_dom$VirtualDom_Expando$viewConstructorOpen(valueList)
					};
				}
			}
		}();
		...
		var description = function () {
			...
			if (_p69._0.ctor === 'Nothing') {
				...
				if (_p69._1.ctor === '[]') {
					return _elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$virtual_dom$VirtualDom_Helpers$text(_p69._0._0)
						]);
				} else {
					return A2(
						_elm_lang$core$List_ops['::'],
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$virtual_dom$VirtualDom_Helpers$onClick(_elm_lang$virtual_dom$VirtualDom_Expando$Toggle)
						]),
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					isClosed ? _elm_lang$virtual_dom$VirtualDom_Helpers$text('') : _elm_lang$virtual_dom$VirtualDom_Expando$viewDictionaryOpen(keyValuePairs)
				]));
	});
	...
	function (maybeKey, isClosed, record) {
		var _p78 = isClosed ? {
			...
			_2: A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$virtual_dom$VirtualDom_Expando$leftPad(
						_elm_lang$core$Maybe$Just(
							{ctor: '_Tuple0'}))
					]),
				_elm_lang$core$Native_List.fromArray(
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					isClosed ? _elm_lang$virtual_dom$VirtualDom_Helpers$text('') : _elm_lang$virtual_dom$VirtualDom_Expando$viewSequenceOpen(valueList)
				]));
	});
...
var _elm_lang$virtual_dom$VirtualDom_Metadata$checkTag = F4(
	function (tag, old, $new, changes) {
		return _elm_lang$core$Native_Utils.eq(old, $new) ? changes : _elm_lang$core$Native_Utils.update(
			changes,
			{
				changed: A2(_elm_lang$core$List_ops['::'], tag, changes.changed)
			});
	});
var _elm_lang$virtual_dom$VirtualDom_Metadata$addTag = F3(
	function (tag, _p11, changes) {
		return _elm_lang$core$Native_Utils.update(
			changes,
			{
				added: A2(_elm_lang$core$List_ops['::'], tag, changes.added)
			});
	});
var _elm_lang$virtual_dom$VirtualDom_Metadata$removeTag = F3(
	function (tag, _p12, changes) {
		return _elm_lang$core$Native_Utils.update(
			changes,
			{
				removed: A2(_elm_lang$core$List_ops['::'], tag, changes.removed)
			});
	});
var _elm_lang$virtual_dom$VirtualDom_Metadata$checkUnion = F4(
	function (name, old, $new, changes) {
		...
		return _elm_lang$virtual_dom$VirtualDom_Report$hasTagChanges(tagChanges) ? changes : A2(
			_elm_lang$core$List_ops['::'],
			A2(_elm_lang$virtual_dom$VirtualDom_Report$UnionChange, name, tagChanges),
			changes);
	});
var _elm_lang$virtual_dom$VirtualDom_Metadata$checkAlias = F4(
	function (name, old, $new, changes) {
		return (_elm_lang$core$Native_Utils.eq(old.tipe, $new.tipe) && _elm_lang$core$Native_Utils.eq(old.args, $new.args)) ? changes : A2(
			_elm_lang$core$List_ops['::'],
			_elm_lang$virtual_dom$VirtualDom_Report$AliasChange(name),
			changes);
	});
...
var _elm_lang$virtual_dom$VirtualDom_Metadata$problemTable = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: _elm_lang$virtual_dom$VirtualDom_Metadata$Function, _1: '->'},
		{ctor: '_Tuple2', _0: _elm_lang$virtual_dom$VirtualDom_Metadata$Decoder, _1: 'Json.Decode.Decoder'},
		{ctor: '_Tuple2', _0: _elm_lang$virtual_dom$VirtualDom_Metadata$Task, _1: 'Task.Task'},
		{ctor: '_Tuple2', _0: _elm_lang$virtual_dom$VirtualDom_Metadata$Process, _1: 'Process.Id'},
		{ctor: '_Tuple2', _0: _elm_lang$virtual_dom$VirtualDom_Metadata$Socket, _1: 'WebSocket.LowLevel.WebSocket'},
		{ctor: '_Tuple2', _0: _elm_lang$virtual_dom$VirtualDom_Metadata$Request, _1: 'Http.Request'},
		{ctor: '_Tuple2', _0: _elm_lang$virtual_dom$VirtualDom_Metadata$Program, _1: 'Platform.Program'},
		{ctor: '_Tuple2', _0: _elm_lang$virtual_dom$VirtualDom_Metadata$VirtualDom, _1: 'VirtualDom.Node'},
		{ctor: '_Tuple2', _0: _elm_lang$virtual_dom$VirtualDom_Metadata$VirtualDom, _1: 'VirtualDom.Attribute'}
	]);
...
var _elm_lang$virtual_dom$VirtualDom_Metadata$collectBadAliases = F3(
	function (name, _p15, list) {
		...
		if (_p17.ctor === '[]') {
			...
			return A2(
				_elm_lang$core$List_ops['::'],
				A2(_elm_lang$virtual_dom$VirtualDom_Metadata$ProblemType, name, _p17),
				list);
		}
	});
var _elm_lang$virtual_dom$VirtualDom_Metadata$collectBadUnions = F3(
	function (name, _p18, list) {
		...
		if (_p20.ctor === '[]') {
			...
			return A2(
				_elm_lang$core$List_ops['::'],
				A2(_elm_lang$virtual_dom$VirtualDom_Metadata$ProblemType, name, _p20),
				list);
		}
	});
...
var _elm_lang$virtual_dom$VirtualDom_History$viewMessage = F3(
	function (currentIndex, index, msg) {
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$virtual_dom$VirtualDom_Helpers$class(className),
					A2(
					_elm_lang$virtual_dom$VirtualDom_Helpers$on,
					'click',
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$virtual_dom$VirtualDom_Helpers$class('messages-entry-content')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$virtual_dom$VirtualDom_Helpers$text(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$virtual_dom$VirtualDom_Helpers$class('messages-entry-index')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$virtual_dom$VirtualDom_Helpers$text(
...
var _elm_lang$virtual_dom$VirtualDom_History$consMsg = F3(
	function (currentIndex, msg, _p0) {
		...
		return {
			...
			_1: A2(
				_elm_lang$core$List_ops['::'],
				A4(_elm_lang$virtual_dom$VirtualDom_Helpers$lazy3, _elm_lang$virtual_dom$VirtualDom_History$viewMessage, currentIndex, _p2, msg),
				_p1._1)
		};
	});
		...
		return A3(
			...
			F2(
				function (elm, msgs) {
					return A2(
						_elm_lang$core$List_ops['::'],
						_elm_lang$virtual_dom$VirtualDom_History$elmToJs(elm),
						msgs);
				}),
			allMessages,
			snapshot.messages);
...
var _elm_lang$virtual_dom$VirtualDom_History$consSnapshot = F3(
	function (currentIndex, snapshot, _p12) {
		...
		return {
			...
			_1: A2(
				_elm_lang$core$List_ops['::'],
				A4(_elm_lang$virtual_dom$VirtualDom_Helpers$lazy3, _elm_lang$virtual_dom$VirtualDom_History$viewSnapshot, currentIndexHelp, _p14, snapshot),
				_p13._1)
		};
	});
...
var _elm_lang$virtual_dom$VirtualDom_History$view = F2(
	function (maybeIndex, _p15) {
		...
		var newStuff = _elm_lang$core$Basics$snd(
			A3(
				_elm_lang$core$List$foldl,
		...
		return A2(
			...
			A2(_elm_lang$core$List_ops['::'], oldStuff, newStuff));
	});
	...
	function (msg, newModel, _p19) {
		...
		return _elm_lang$core$Native_Utils.eq(_p23, _elm_lang$virtual_dom$VirtualDom_History$maxSnapshotSize) ? {
			...
			_1: A3(
				_elm_lang$virtual_dom$VirtualDom_History$RecentHistory,
				_p22,
				A2(_elm_lang$core$List_ops['::'], msg, _p21),
				_p23 + 1)
		};
	});
...
var _elm_lang$virtual_dom$VirtualDom_Overlay$button = F2(
	function (msg, label) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$virtual_dom$VirtualDom_Helpers$onClick(msg),
					_elm_lang$virtual_dom$VirtualDom_Helpers$style(
					_elm_lang$core$Native_List.fromArray(
						[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$virtual_dom$VirtualDom_Helpers$text(label)
				]));
	});
var _elm_lang$virtual_dom$VirtualDom_Overlay$viewImportExport = F3(
	function (props, importMsg, exportMsg) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					A2(_elm_lang$virtual_dom$VirtualDom_Overlay$button, importMsg, 'Import'),
					_elm_lang$virtual_dom$VirtualDom_Helpers$text(' / '),
					A2(_elm_lang$virtual_dom$VirtualDom_Overlay$button, exportMsg, 'Export')
				]));
	});
var _elm_lang$virtual_dom$VirtualDom_Overlay$viewMiniControls = F2(
	function (config, numMsgs) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$virtual_dom$VirtualDom_Helpers$class('elm-mini-controls')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$virtual_dom$VirtualDom_Helpers$onClick(config.open),
							_elm_lang$virtual_dom$VirtualDom_Helpers$class('elm-mini-controls-button')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$virtual_dom$VirtualDom_Helpers$text(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$virtual_dom$VirtualDom_Helpers$class('elm-mini-controls-import-export')
						]),
			...
			if (_p0._1._1.ctor === '[]') {
				...
				return A2(
					...
					A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A2(_elm_lang$core$Basics_ops['++'], ' and ', _p0._0)
							])));
			}
		}
	}
...
var _elm_lang$virtual_dom$VirtualDom_Overlay$viewCode = function (name) {
	return A3(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$virtual_dom$VirtualDom_Helpers$text(name)
			]));
};
		...
		if (_p2.ctor === '[]') {
			...
			if (_p2._1.ctor === '[]') {
				return A3(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$virtual_dom$VirtualDom_Helpers$text(verbed),
							_p2._0,
							_elm_lang$virtual_dom$VirtualDom_Helpers$text('.')
						]));
			} else {
					...
					return A3(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$virtual_dom$VirtualDom_Helpers$text(verbed),
								_p2._1._0,
								_elm_lang$virtual_dom$VirtualDom_Helpers$text(' and '),
								_p2._0,
								_elm_lang$virtual_dom$VirtualDom_Helpers$text('.')
							]));
				} else {
			...
			if (_p3.ctor === 'AliasChange') {
				return _elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$virtual_dom$VirtualDom_Helpers$class('elm-overlay-message-details-type')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$virtual_dom$VirtualDom_Overlay$viewCode(_p3._0)
							]))
					]);
			} else {
				return _elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A2(_elm_lang$virtual_dom$VirtualDom_Overlay$viewMention, _p3._1.removed, 'Removed '),
								A2(_elm_lang$virtual_dom$VirtualDom_Overlay$viewMention, _p3._1.changed, 'Changed '),
								A2(_elm_lang$virtual_dom$VirtualDom_Overlay$viewMention, _p3._1.added, 'Added ')
							])),
						_p3._1.argsMatch ? _elm_lang$virtual_dom$VirtualDom_Helpers$text('') : _elm_lang$virtual_dom$VirtualDom_Helpers$text('This may be due to the fact that the type variable names changed.')
					]);
			}
		}());
};
var _elm_lang$virtual_dom$VirtualDom_Overlay$viewProblemType = function (_p4) {
	...
	return A3(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$virtual_dom$VirtualDom_Overlay$viewCode(_p5.name),
				_elm_lang$virtual_dom$VirtualDom_Helpers$text(
				A2(
					_elm_lang$core$Basics_ops['++'],
					' can contain ',
...
var _elm_lang$virtual_dom$VirtualDom_Overlay$viewBadMetadata = function (_p6) {
	...
	return _elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$virtual_dom$VirtualDom_Helpers$text('The '),
					_elm_lang$virtual_dom$VirtualDom_Overlay$viewCode(_p7.message),
					_elm_lang$virtual_dom$VirtualDom_Helpers$text(' type of your program cannot be reliably serialized for history files.')
				])),
			A3(
			_elm_lang$virtual_dom$VirtualDom_Helpers$node,
			'p',
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$virtual_dom$VirtualDom_Helpers$text('Functions cannot be serialized, nor can values that contain functions. This is a problem in these places:')
				])),
			A3(
			_elm_lang$virtual_dom$VirtualDom_Helpers$node,
			'ul',
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$virtual_dom$VirtualDom_Helpers$text(_elm_lang$virtual_dom$VirtualDom_Overlay$goodNews1),
					A2(
					_elm_lang$virtual_dom$VirtualDom_Helpers$a,
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$virtual_dom$VirtualDom_Helpers$href('https://guide.elm-lang.org/types/union_types.html')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$virtual_dom$VirtualDom_Helpers$text('union types')
						])),
					_elm_lang$virtual_dom$VirtualDom_Helpers$text(', in your messages. From there, your '),
					_elm_lang$virtual_dom$VirtualDom_Overlay$viewCode('update'),
					_elm_lang$virtual_dom$VirtualDom_Helpers$text(_elm_lang$virtual_dom$VirtualDom_Overlay$goodNews2)
				]))
		]);
};
	...
	function (isBad, report) {
		...
		switch (_p8.ctor) {
			case 'CorruptHistory':
				return _elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$virtual_dom$VirtualDom_Helpers$text('Looks like this history file is corrupt. I cannot understand it.')
					]);
			case 'VersionChanged':
				return _elm_lang$core$Native_List.fromArray(
					[
			...
			case 'MessageChanged':
				return _elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$virtual_dom$VirtualDom_Overlay$viewCode(_p8._0),
						_elm_lang$virtual_dom$VirtualDom_Helpers$text(' messages, but the new program works with '),
						_elm_lang$virtual_dom$VirtualDom_Overlay$viewCode(_p8._1),
						_elm_lang$virtual_dom$VirtualDom_Helpers$text(' messages.')
					]);
			default:
				return _elm_lang$core$Native_List.fromArray(
					[
...
var _elm_lang$virtual_dom$VirtualDom_Overlay$viewResume = function (config) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$virtual_dom$VirtualDom_Helpers$class('elm-overlay-resume'),
				_elm_lang$virtual_dom$VirtualDom_Helpers$onClick(config.resume)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$virtual_dom$VirtualDom_Helpers$class('elm-overlay-resume-words')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$virtual_dom$VirtualDom_Helpers$text('Click to Resume')
					]))
			]));
};
...
var _elm_lang$virtual_dom$VirtualDom_Overlay$viewButtons = function (buttons) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$virtual_dom$VirtualDom_Helpers$class('elm-overlay-message-buttons')
			]),
		function () {
			var _p15 = buttons;
			if (_p15.ctor === 'Accept') {
				return _elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$virtual_dom$VirtualDom_Helpers$onClick(_elm_lang$virtual_dom$VirtualDom_Overlay$Proceed)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$virtual_dom$VirtualDom_Helpers$text(_p15._0)
							]))
					]);
			} else {
				return _elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$virtual_dom$VirtualDom_Helpers$onClick(_elm_lang$virtual_dom$VirtualDom_Overlay$Cancel)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$virtual_dom$VirtualDom_Helpers$text(_p15._0)
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$virtual_dom$VirtualDom_Helpers$text(_p15._1)
							]))
					]);
			}
		}());
		...
		return {
			...
			_1: _elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$virtual_dom$VirtualDom_Helpers$class('elm-overlay-message')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$virtual_dom$VirtualDom_Helpers$class('elm-overlay-message-title')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$virtual_dom$VirtualDom_Helpers$text(title)
								])),
							A2(
							_elm_lang$virtual_dom$VirtualDom_Helpers$div,
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$virtual_dom$VirtualDom_Helpers$class('elm-overlay-message-details')
								]),
							details),
							A2(
							_elm_lang$virtual_dom$VirtualDom_Helpers$map,
...
var _elm_lang$virtual_dom$VirtualDom_Overlay$viewHelp = F5(
	function (config, isPaused, isOpen, numMsgs, state) {
		...
		switch (_p16.ctor) {
			case 'None':
				var miniControls = isOpen ? _elm_lang$core$Native_List.fromArray(
					[]) : _elm_lang$core$Native_List.fromArray(
					[
						A2(_elm_lang$virtual_dom$VirtualDom_Overlay$viewMiniControls, config, numMsgs)
					]);
				return {
					ctor: '_Tuple2',
					_0: isPaused ? _elm_lang$virtual_dom$VirtualDom_Overlay$Pause : _elm_lang$virtual_dom$VirtualDom_Overlay$Normal,
					_1: (isPaused && (!isOpen)) ? A2(
						_elm_lang$core$List_ops['::'],
						_elm_lang$virtual_dom$VirtualDom_Overlay$viewResume(config),
	...
	function (config, isPaused, isOpen, numMsgs, state) {
		...
		return {
			...
			_1: A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$virtual_dom$VirtualDom_Helpers$class('elm-overlay')
					]),
				A2(_elm_lang$core$List_ops['::'], _elm_lang$virtual_dom$VirtualDom_Overlay$styles, nodes))
		};
	});
...
var _elm_lang$virtual_dom$VirtualDom_Debug$resumeButton = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$virtual_dom$VirtualDom_Helpers$onClick(_elm_lang$virtual_dom$VirtualDom_Debug$Resume),
			_elm_lang$virtual_dom$VirtualDom_Helpers$class('debugger-sidebar-controls-resume')
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$virtual_dom$VirtualDom_Helpers$text('Resume')
		]));
...
var _elm_lang$virtual_dom$VirtualDom_Debug$playButton = function (maybeIndex) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$virtual_dom$VirtualDom_Helpers$class('debugger-sidebar-controls')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$virtual_dom$VirtualDom_Debug$viewResumeButton(maybeIndex),
				A2(
				_elm_lang$virtual_dom$VirtualDom_Helpers$div,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$virtual_dom$VirtualDom_Helpers$class('debugger-sidebar-controls-import-export')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_elm_lang$virtual_dom$VirtualDom_Debug$button, _elm_lang$virtual_dom$VirtualDom_Debug$Import, 'Import'),
						_elm_lang$virtual_dom$VirtualDom_Helpers$text(' / '),
						A2(_elm_lang$virtual_dom$VirtualDom_Debug$button, _elm_lang$virtual_dom$VirtualDom_Debug$Export, 'Export')
					]))
			]));
};
var _elm_lang$virtual_dom$VirtualDom_Debug$viewSidebar = F2(
	function (state, history) {
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$virtual_dom$VirtualDom_Helpers$class('debugger-sidebar')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$virtual_dom$VirtualDom_Debug$playButton(maybeIndex)
				]));
	});
...
var _elm_lang$virtual_dom$VirtualDom_Debug$viewOut = function (_p9) {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$virtual_dom$VirtualDom_Helpers$id('debugger')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$virtual_dom$VirtualDom_Debug$styles,
				A2(_elm_lang$virtual_dom$VirtualDom_Debug$viewSidebar, _p10.state, _p10.history),
				A2(
				_elm_lang$virtual_dom$VirtualDom_Helpers$map,
				...
				A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$virtual_dom$VirtualDom_Helpers$id('values')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(_elm_lang$virtual_dom$VirtualDom_Expando$view, _elm_lang$core$Maybe$Nothing, _p10.expando)
						])))
			]));
};
...
var _elm_lang$virtual_dom$VirtualDom_Debug$wrapInit = F2(
	function (metadata, _p11) {
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					A2(_elm_lang$core$Platform_Cmd$map, _elm_lang$virtual_dom$VirtualDom_Debug$UserMsg, _p12._1)
				]));
	});
		...
		if (_p23.ctor === 'Running') {
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						commands,
						A2(_elm_lang$virtual_dom$VirtualDom_Debug$runIf, _p24.isDebuggerOpen, scrollTask)
					]));
		} else {
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				...
				case 'Resume':
					...
					if (_p27.ctor === 'Running') {
						...
						return A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									A2(_elm_lang$virtual_dom$VirtualDom_Debug$runIf, model.isDebuggerOpen, scrollTask)
								]));
					}
				case 'Jump':
					var _p30 = _p26._0;
					...
					return A2(
						...
						function (_p34) {
							return A2(
								...
								model,
								_elm_lang$core$Native_List.fromArray(
									[_elm_lang$virtual_dom$VirtualDom_Debug$upload]));
						});
				case 'Export':
					return A2(
						_elm_lang$virtual_dom$VirtualDom_Debug$withGoodMetadata,
						...
						function (metadata) {
							return A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										A2(_elm_lang$virtual_dom$VirtualDom_Debug$download, metadata, model.history)
									]));
						});
				case 'Upload':
					return A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Elm land')
							])),
						A2(
